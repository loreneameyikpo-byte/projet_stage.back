        ...
        <tr>
            <td style="padding: 32px;">
                ...
                <p style="font-size: 14px; color: #1F2937; line-height: 1.6; margin: 0 0 16px;">
                    {{ $projet->encadreur->prenom }} {{ $projet->encadreur->nom }} a laissé une observation sur votre projet :
                </p>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #F3FAFD; border-radius: 6px; margin-bottom: 20px;">
                    <tr>
                        <td style="padding: 16px;">
                            ...
                            <p style="font-size: 13px; color: #64748B; margin: 0 0 4px;">Observation</p>
                            <p style="font-size: 14px; color: #1F2937; margin: 0; white-space: pre-line;">{{ $observation->contenu }}</p>
                        </td>
                    </tr>
                </table>
                ...
                @if ($decision !== 'valider')
                    <p style="font-size: 13px; color: #64748B; line-height: 1.6; margin: 0 0 24px;">
                        Vous pouvez déposer une nouvelle version corrigée depuis votre espace étudiant.
                    </p>
                @else
                    <p style="font-size: 13px; color: #64748B; line-height: 1.6; margin: 0 0 24px;">
                        Votre projet est maintenant en attente de planification de soutenance.
                    </p>
                @endif
