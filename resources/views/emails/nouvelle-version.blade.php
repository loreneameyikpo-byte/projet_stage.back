        ...
        <tr>
            <td style="padding: 32px;">
                ...
                <p style="font-size: 14px; color: #1F2937; line-height: 1.6; margin: 0 0 16px;">
                    {{ $projet->etudiant->prenom }} {{ $projet->etudiant->nom }} vient de déposer une nouvelle version de son projet :
                </p>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #F6FAF9; border-radius: 6px; margin-bottom: 20px;">
                    <tr>
                        <td style="padding: 16px;">
                            ...
                            <p style="font-size: 13px; color: #64748B; margin: 0 0 4px;">Version</p>
                            <p style="font-size: 14px; color: #1F2937; margin: 0 0 12px; font-weight: 600;">{{ $version->numero_version }}</p>

                            <p style="font-size: 13px; color: #64748B; margin: 0 0 4px;">Déposée le</p>
                            <p style="font-size: 14px; color: #1F2937; margin: 0; font-weight: 600;">{{ $version->date_depot }}</p>
                        </td>
                    </tr>
                </table>

                <p style="font-size: 13px; color: #64748B; line-height: 1.6; margin: 0 0 24px;">
                    Vous pouvez consulter cette nouvelle version depuis votre espace encadreur.
                </p>
